"""
STEP 10 — RISK TIERS & BUSINESS OUTPUT (FIXED)
"""
import pandas as pd
import numpy as np
import pickle
...
print("=" * 60)
print("STEP 10 — RISK TIERS & BUSINESS OUTPUT (FIXED)")
print("=" * 60)
...
axes[0].set_title('Applicant Distribution by Risk Tier (FIXED)', fontsize=12, fontweight='bold')
...
plt.tight_layout()
plt.savefig(r'c:\Users\gargd\Downloads\credit_risk_project\outputs\risk_segmentation_FIXED.png', dpi=300, bbox_inches='tight')
plt.close()
print("   ✅ Saved: outputs/risk_segmentation_FIXED.png")
...
with open(r'c:\Users\gargd\Downloads\credit_risk_project\data\business_metrics_FIXED.json', 'w') as f:
    json.dump(business_metrics, f, indent=2)
print("💾 Saved business metrics (FIXED)")
